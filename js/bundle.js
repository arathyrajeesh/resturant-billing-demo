          ...
          <div class="item-modal-body">
            ...
            <div class="custom-section">
              ...
              <div class="quick-notes-chips">
                <button type="button" class="note-chip" onclick="window.app.appendQuickNote('Not Spicy')">🌶️ Not Spicy</button>
                <button type="button" class="note-chip" onclick="window.app.appendQuickNote('Less Spicy')">Mild / Less Spicy</button>
                <button type="button" class="note-chip" onclick="window.app.appendQuickNote('Extra Spicy')">🔥 Extra Spicy</button>
                <button type="button" class="note-chip" onclick="window.app.appendQuickNote('Without onion and garlic')">Without Onion & Garlic</button>
                <button type="button" class="note-chip" onclick="window.app.appendQuickNote('Less Oil')">Less Oil</button>
                <button type="button" class="note-chip" onclick="window.app.appendQuickNote('Extra Gravy')">Extra Gravy</button>
                <button type="button" class="note-chip" onclick="window.app.appendQuickNote('No Sugar')">No Sugar</button>
              </div>
            </div>
          </div>
            ...
            <div class="panel-card">
              ...
              <div class="swiggy-menu-list">
                ${filteredMenu.map(item => {
                  ...
                  return `
                    <div class="swiggy-item-card" style="display:flex !important; flex-direction:row !important; align-items:flex-start !important; justify-content:space-between !important; gap:12px !important;">
                      <div class="swiggy-item-right" style="width:92px !important; min-width:92px !important; max-width:92px !important; flex:0 0 92px !important; display:flex !important; flex-direction:column !important; align-items:center !important; margin-right:8px !important;">
                        <img src="${itemImg}" class="swiggy-item-img" alt="${item.name}" style="width:86px !important; height:80px !important; border-radius:12px !important; object-fit:cover !important; display:block !important;" onerror="this.onerror=null; this.src='https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=500&auto=format&fit=crop&q=80';" />
                      </div>

                      <div class="swiggy-item-left" style="flex:1 1 auto !important; min-width:0 !important;">
                  ...
                  <div class="table-card-std ${t.status}">
                    ...
                    <div style="display:flex; flex-direction:column; gap:4px; width:100%; margin-top:8px;">
                      <div style="display:flex; gap:6px; width:100%; align-items:center;">
                        ...
                        <button class="table-qr-btn" style="flex:1 1 0%; min-width:0; background:#0284C7; color:#FFF; padding:7px 4px; font-size:11px; font-weight:700; white-space:nowrap; overflow:hidden; text-overflow:ellipsis;" onclick="window.app.openQRModal(${t.id})" title="Show QR Code for ${t.number}">📱 QR Code</button>
                      </div>
                      ${tableOrder ? `
